...
using namespace std;
string user_path = R"(C:\Users\\Softlaptop\Desktop\CProjects\AskMe\users.txt)";
string question_path = R"(C:\Users\\Softlaptop\Desktop\CProjects\AskMe\questions.txt)";
string answer_path = R"(C:\Users\\Softlaptop\Desktop\CProjects\AskMe\answers.txt)";
string user_id_path = R"(C:\Users\\Softlaptop\Desktop\CProjects\AskMe\user_id.txt)";
string question_id_path = R"(C:\Users\\Softlaptop\Desktop\CProjects\AskMe\question_id.txt)";
string answer_id_path = R"(C:\Users\\Softlaptop\Desktop\CProjects\AskMe\answer_id.txt)";
vector<User> users;
...
void feed() {
    for (int i = 0; i < questions.size(); ++i) {
        if (questions[i].get_state()) {
            cout << "\t" << i + 1 << "- \"Unknown person" << "\" asked \"" << questions[i].get_to_user() << "\" \""
                 << questions[i].get_text() << "\"\n";
        } else {
            cout << "\t" << i + 1 << "- \"" << questions[i].get_from_user() << "\" asked \""
                 << questions[i].get_to_user() << "\" \"" << questions[i].get_text() << "\"\n";
        }
        int check_answer = 1;
